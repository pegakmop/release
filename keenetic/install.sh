...
opkg install wget-ssl vim nano
...
echo "Install HydraRouteNeo package:"
echo "opkg install hrneo"

echo "Remove HydraRouteNeo package:"
echo "opkg remove hrneo"
#opkg install hrneo || echo "Package 'hydraroute' not found in feed. Skipping."
